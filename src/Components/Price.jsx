    ...
    <>
       <div className='mt-20'>
           ...
           <div className='flex flex-wrap'>
             {
                pricingOptions.map((pricingOptions, i)=>(
                    <div key={i} className="w-full sm:w-1/2 lg:w-1/3 p-2" >
                        <div className='p-10 border border-neutral-700 rounded-xl'>
                            <p className='text-4xl mb-8'>
                                {pricingOptions.title}
                                {pricingOptions.title === "Pro" && (
                                    <span className='bg-gradient-to-r from-orange-400 to-red-700 text-transparent bg-clip-text text-xl mb-4 ml-2'>(Most Populer)</span>
                                )}
                            </p>
                            <p>
                                <span className='text-5xl mt-6 mr-2'>{pricingOptions.price}</span>
